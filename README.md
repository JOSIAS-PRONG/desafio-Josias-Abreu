...
- Combos não são considerados como item principal. (ok) ========
- É possível pedir mais de um item extra sem precisar de mais de um principal. (OK) ========
- Se não forem pedidos itens, apresentar mensagem "Não há itens no carrinho de compra!"(OK) ========
- Se a quantidade de itens for zero, apresentar mensagem "Quantidade inválida!".(OK) ========
- Se o código do item não existir, apresentar mensagem "Item inválido!" (OK) ========
- Se a forma de pagamento não existir, apresentar mensagem "Forma de pagamento inválida!" (OK) ========
...
C:\Users\josia\OneDrive\Área de Trabalho\desafio-lanchonete-2023
> ALERTA:
